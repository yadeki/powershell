...
$Destination="\\192.168.2.203\Data\Backups\ELEMENTS_1TB" #Copy the Files to this Location
$Versions="50" #How many of the last Backups you want to keep
$BackupDirs="E:\" #What Folders you want to backup
$Log="C:\BackupLog\Log.txt" #Log Name
